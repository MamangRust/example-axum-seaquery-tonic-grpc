...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ApiResponseUserResponse {
    #[prost(string, tag = "1")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ApiResponsesUserResponse {
    #[prost(string, tag = "1")]
    pub status: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub message: ::prost::alloc::string::String,
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn find_all_users(
            ...
            tonic::Response<super::ApiResponsesUserResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "FindAllUsers"));
        ...
        pub async fn create_user(
            ...
            tonic::Response<super::ApiResponseUserResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/user.UserService/FindAllUsers" => {
                    ...
                    struct FindAllUsersSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::FindAllUserRequest>
                    for FindAllUsersSvc<T> {
                        type Response = super::ApiResponsesUserResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UserService>::find_all_users(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = FindAllUsersSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/user.UserService/CreateUser" => {
                    ...
                    for CreateUserSvc<T> {
                        type Response = super::ApiResponseUserResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
